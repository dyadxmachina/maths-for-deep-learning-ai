...
The story of Pitts and McCulloch is also the story of cybernetics which was born out of the influences of ideas from a variety of domains and fields, and in a way a neural network symbolizes this interaction. 
...
By stringing the simple neurons into chains and loops, they had shown that it is possible for brain to implement every possible logical operation and outputting anything that could be calculated by one of Turing's hypothetical machines. 

We started to come to a realization that the knowledge of the world is not within ourselves, our reasoning process or our mind but instead, it exists out there in the world. This new realization brought a whole new paradigm shift in the development of AI. 

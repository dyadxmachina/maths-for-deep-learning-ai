...
The first fully functioning eletronic digital computer was Colossus, used by the Bletchley Park cryptanalysts from 1944. 

Before von Neumann architecture machine, designed by physicist and mathematician John von Neumann (1903–1957) is a theoretical design for a stored program computer that serves as the basis for almost all modern computers.
self -replicaing machines 
...
Beginning in 1949, von Neumann's design for a self-reproducing computer program is considered the world's first computer virus, and he is considered to be the theoretical father of computer virology.[1

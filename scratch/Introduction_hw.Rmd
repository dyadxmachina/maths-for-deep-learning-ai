...
%As mentioned earlier, Expert systems is also considered as a brach of Symbolic AI. It was introduced around 1965 by the Stanford Heuristic Programming Project led by Edward Feigenbaum, who is often called the 'father of expert systems'.
...
As a result, an expert system (ES) could be used to solve problems within specialized domain that ordinary requires a human expert. By mimicking the thinking of the expert, the program can perform the analysis, design, or monitoring, make decisions and many more other tasks. 

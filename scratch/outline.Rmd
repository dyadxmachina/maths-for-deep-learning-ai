...
> The hypothesis [is] that intelligence is the work of symbol systems ... the hypothesis is that a physical symbol system ... has the necessary and sufficient means for *general intelligent action*. - Herbert Simon, The Sciences of the Artificial


Most of the work in AI so far, fits into the symbolic AI paradigm. Claude Shannon's master thesis (1937), A Symbolic Analysis of Relay and Switching Circuits, placed symbolic logic (Boole's) at the center of today's computing machinery. 
...
Expert systems were one of the main application areas of symbolic AI which lead to much industry success then and now. Expert systems takes a hybrid apprach to human-machine interaction. Given we are aware that there are many human experts, experts systems engineers ask, how can we take an experts knowledge and teach a machine to make decisions like the human does. The question is answered by encoding those rules directly into the system. This means taking an experts knowledge and converting it into a set of rules and facts. The power of expert systems not from being a knowledge database but the ability to reason or deduce over these facts.
This separation between knowledge (facts and rules) and inference (deductions) was one of the first of its kind and has become a key part of symbolic AI. 

The first of these systems (recorded) were in the 1960s. Edward Feigenbaum, often titled the father of expert systems, where he and others worked on the Stanford Heuristic Programming Project.

He would also worked on Mycin, Dendral, all expert systems technology
...
#### In 1980, provided Searle posited that 

#### Simulated thinking vs actually thinking
